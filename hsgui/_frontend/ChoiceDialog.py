...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(QtWidgets.QApplication.translate("Dialog", "The Images are the chips.", None))
        self.pushButton_2.setText(QtWidgets.QApplication.translate("Dialog", "Add chips yourself, manually.", None))
