...
class Ui_mainSkel(object):
    ...
    def retranslateUi(self, mainSkel):
        ...
        self.actionOpen_Database.setText(QtWidgets.QApplication.translate("mainSkel", "Open Database", None))
        self.actionOpen_Database.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Opens a different database directory. ", None))
        self.actionOpen_Database.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+O", None))
        self.actionSave_Database.setText(QtWidgets.QApplication.translate("mainSkel", "Save Database", None))
        self.actionSave_Database.setIconText(QtWidgets.QApplication.translate("mainSkel", "Save Database", None))
        self.actionSave_Database.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Saves the added images / chip properties / and changed names to the database csv tables.", None))
        self.actionSave_Database.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+S", None))
        self.actionImport_Img_file.setText(QtWidgets.QApplication.translate("mainSkel", "Import Images (select file(s))", None))
        self.actionImport_Img_file.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+I", None))
        self.actionOpen_Data_Directory.setText(QtWidgets.QApplication.translate("mainSkel", "View Data Directory", None))
        self.actionOpen_Source_Directory.setText(QtWidgets.QApplication.translate("mainSkel", "View Source Directory", None))
        self.actionUndockDisplay.setText(QtWidgets.QApplication.translate("mainSkel", "Undock Display", None))
        self.actionTogPlt.setText(QtWidgets.QApplication.translate("mainSkel", "Toggle PlotWidget", None))
        self.actionHelpCMD.setText(QtWidgets.QApplication.translate("mainSkel", "Command Line Help", None))
        self.actionHelpGUI.setText(QtWidgets.QApplication.translate("mainSkel", "GUI Help", None))
        self.actionAbout.setText(QtWidgets.QApplication.translate("mainSkel", "About", None))
        self.actionHelpWorkflow.setText(QtWidgets.QApplication.translate("mainSkel", "Workflow Help", None))
        self.actionAdd_Chip.setText(QtWidgets.QApplication.translate("mainSkel", "Add Chip", None))
        self.actionAdd_Chip.setToolTip(QtWidgets.QApplication.translate("mainSkel", "When adding a chip, you select an ROI in Image View. The ROI defines a new chip and it is added (but not saved) to the database.", None))
        self.actionAdd_Chip.setShortcut(QtWidgets.QApplication.translate("mainSkel", "A", None))
        self.actionReselect_ROI.setText(QtWidgets.QApplication.translate("mainSkel", "Reselect ROI", None))
        self.actionReselect_ROI.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Changes the ROI of a chip. Previously associated results and chip data are removed and recomputed. ", None))
        self.actionReselect_ROI.setShortcut(QtWidgets.QApplication.translate("mainSkel", "R", None))
        self.actionNext.setText(QtWidgets.QApplication.translate("mainSkel", "Select Next", None))
        self.actionNext.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Selects the next image or chip in the database. ", None))
        self.actionNext.setShortcut(QtWidgets.QApplication.translate("mainSkel", "N", None))
        self.actionDelete_Chip.setText(QtWidgets.QApplication.translate("mainSkel", "Delete Chip", None))
        self.actionDelete_Chip.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Removes a chip from the database. ", None))
        self.actionDelete_Chip.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+Del", None))
        self.actionQuery.setText(QtWidgets.QApplication.translate("mainSkel", "Query", None))
        self.actionQuery.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Issues the currently selected chip as a query. The result table is then populated.", None))
        self.actionQuery.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Q", None))
        self.actionPrev.setText(QtWidgets.QApplication.translate("mainSkel", "Prev", None))
        self.actionWriteLogs.setText(QtWidgets.QApplication.translate("mainSkel", "Write Logs", None))
        self.actionOpen_Internal_Directory.setText(QtWidgets.QApplication.translate("mainSkel", "View Internal Directory", None))
        self.actionPreferences.setText(QtWidgets.QApplication.translate("mainSkel", "Edit Preferences", None))
        self.actionPreferences.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Changes algorithm parameters and program behavior.", None))
        self.actionPreferences.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+P", None))
        self.actionQuit.setText(QtWidgets.QApplication.translate("mainSkel", "Quit", None))
        self.actionQuit.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Exits the program", None))
        self.actionConvertImage2Chip.setText(QtWidgets.QApplication.translate("mainSkel", "Convert All Images to Chips", None))
        self.actionBatch_Change_Name.setText(QtWidgets.QApplication.translate("mainSkel", "Batch Change Name", None))
        self.actionReselect_Ori.setText(QtWidgets.QApplication.translate("mainSkel", "Reselect Orientation", None))
        self.actionReselect_Ori.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Changes the orientation of a chip. Previously associated results and chip data are removed and recomputed. ", None))
        self.actionReselect_Ori.setShortcut(QtWidgets.QApplication.translate("mainSkel", "O", None))
        self.actionAdd_Metadata_Property.setText(QtWidgets.QApplication.translate("mainSkel", "Add Chip Property", None))
        self.actionAutoassign.setText(QtWidgets.QApplication.translate("mainSkel", "Assign Matches Above Threshold", None))
        self.actionRankErrorExpt.setText(QtWidgets.QApplication.translate("mainSkel", "Rank Error Experiment", None))
        self.actionName_Consistency_Experiment.setText(QtWidgets.QApplication.translate("mainSkel", "Name Consistency", None))
        self.actionIncrease_ROI_Size.setText(QtWidgets.QApplication.translate("mainSkel", "Increase all ROI Sizes", None))
        self.actionView_Docs.setText(QtWidgets.QApplication.translate("mainSkel", "View Documentation", None))
        self.actionAutoassign_2.setText(QtWidgets.QApplication.translate("mainSkel", "Auto-Assign Matches", None))
        self.actionNew_Database.setText(QtWidgets.QApplication.translate("mainSkel", "New Database", None))
        self.actionNew_Database.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Create a new folder to use as a database. ", None))
        self.actionNew_Database.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+N", None))
        self.actionImport_Img_dir.setText(QtWidgets.QApplication.translate("mainSkel", "Import Images (select directory)", None))
        self.actionPrecompute_Queries.setText(QtWidgets.QApplication.translate("mainSkel", "Precompute Queries", None))
        self.actionPrecompute_Queries.setToolTip(QtWidgets.QApplication.translate("mainSkel", "This might take anywhere from a coffee break to an overnight  procedure depending on how many ROIs you\'ve made. It queries each chip and saves the result which allows multiple queries to be rapidly inspected later. ", None))
        self.actionPrecomputeChipsFeatures.setText(QtWidgets.QApplication.translate("mainSkel", "Precompute Chips/Features", None))
        self.actionPrecomputeChipsFeatures.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Extracts all chips from images, and computes features. This loads the data into memory and reduces waiting time between selecting chips and images.", None))
        self.actionPrecomputeChipsFeatures.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+Return", None))
        self.actionView_DBDir.setText(QtWidgets.QApplication.translate("mainSkel", "View Database Dir", None))
        self.actionView_DBDir.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Opens the database folder in your operating system\'s native file browser (explorer/finder/nautilus)", None))
        self.actionScale_all_ROIS.setText(QtWidgets.QApplication.translate("mainSkel", "Scale all ROIs", None))
        self.actionScale_all_ROIS.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Changes the size of every ROI in the database. ", None))
        self.actionConvert_all_images_into_chips.setText(QtWidgets.QApplication.translate("mainSkel", "Convert all images into chips", None))
        self.actionConvert_all_images_into_chips.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Every image without a chip has an ROI added to it spanning the entire image.", None))
        self.actionNew_Chip_Property.setText(QtWidgets.QApplication.translate("mainSkel", "New Chip Property", None))
        self.actionNew_Chip_Property.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Creates a new column in the chip table for user properties.", None))
        self.actionDelete_computed_directory.setText(QtWidgets.QApplication.translate("mainSkel", "Delete Computed Directory", None))
        self.actionDelete_computed_directory.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Deletes all precomputations (not your ROIs or properties though) and lets all data be recomputed and reloaded. This puts your database in a cleaner state. ", None))
        self.actionDelete_global_preferences.setText(QtWidgets.QApplication.translate("mainSkel", "Delete Global Preferences", None))
        self.actionDelete_global_preferences.setToolTip(QtWidgets.QApplication.translate("mainSkel", "This deletes global preferences like the previously opened database, your work directory, and defaults algorithm preferences. Use if HotSpotter crashes on loading a database. ", None))
        self.actionView_Computed_Dir.setText(QtWidgets.QApplication.translate("mainSkel", "View Computed Dir", None))
        self.actionView_Computed_Dir.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Opens the directory where all precomputed chips, query results, and features are stored. ", None))
        self.actionView_Global_Dir.setText(QtWidgets.QApplication.translate("mainSkel", "View Global Dir", None))
        self.actionView_Global_Dir.setToolTip(QtWidgets.QApplication.translate("mainSkel", "This is youre ~/.hotspotter folder, which stores non-database-specific preferences.", None))
        self.actionLayout_Figures.setText(QtWidgets.QApplication.translate("mainSkel", "Layout Figures", None))
        self.actionLayout_Figures.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Organizes windows in a grid", None))
        self.actionLayout_Figures.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+L", None))
        self.actionDev_Mode_IPython.setText(QtWidgets.QApplication.translate("mainSkel", "Developer Mode (IPython)", None))
        self.actionDev_Mode_IPython.setToolTip(QtWidgets.QApplication.translate("mainSkel", "This allows IPython interaction in the terminal and disables GUI interaction until the \"exit\" command is entered in IPython. ", None))
        self.actionDev_Mode_IPython.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+Alt+Shift+D", None))
        self.actionDelete_Precomputed_Results.setText(QtWidgets.QApplication.translate("mainSkel", "Delete Cached Query Results", None))
        self.actionDelete_Precomputed_Results.setToolTip(QtWidgets.QApplication.translate("mainSkel", "Removes all precomputed results. Use if you expect that your results may be corrupted.", None))
        self.actionDeveloper_Reload.setText(QtWidgets.QApplication.translate("mainSkel", "Developer Reload", None))
        self.actionDeveloper_Reload.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+Shift+R", None))
        self.actionDelete_Image.setText(QtWidgets.QApplication.translate("mainSkel", "Trash Image", None))
        self.actionDelete_Image.setShortcut(QtWidgets.QApplication.translate("mainSkel", "Ctrl+Shift+Del", None))
