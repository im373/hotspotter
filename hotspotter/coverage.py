...
rrr = make_reloader(__name__, '[cov]')
# Standard
...
def score_chipmatch_coverage(hs, qcx, chipmatch, qreq, method=0):
    ...
    mark_progress, end_progress = progress.progress_func(nRerank, flush_after=10,
...
def warp_srcimg_to_kpts(fx2_kp, srcimg, chip_shape, fx2_score=None, **kwargs):
    ...
    # mark prooress
    mark_progress, end_progress = progress.progress_func(len(fx2_M),
                                                     flush_after=20,
                                                     mark_after=1000,
                                                     lbl='coverage warp ')
